...
class ResetScreen extends StatefulWidget {
  ...
  ResetScreen(this.novoEmail, this.novoNome);

  @override
  _ResetScreenState createState() => _ResetScreenState(novoEmail, novoNome);
}
...
class _ResetScreenState extends State<ResetScreen> {
  ...
  _ResetScreenState(this.novoEmail, this.novoNome);
  ...
  void _onSuccess() {
    Map<String, dynamic> userData = {
      "nome": novoNome,
      "email": novoEmail,
      "pontos": UserModel.of(context).userData['pontos'],
      "vidas": UserModel.of(context).userData['vidas'],
      "vidasExtra": UserModel.of(context).userData['vidasExtra'],
    };
