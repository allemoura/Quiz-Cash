...
class SemVidasExtraScreen extends StatefulWidget {
  @override
  _SemVidasExtraScreenState createState() => _SemVidasExtraScreenState();
}

class _SemVidasExtraScreenState extends State<SemVidasExtraScreen> {
  String date;
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(children: <Widget>[
      ...
      Container(
        ...
        image: AssetImage("images/acabouVidasExtra.png"),
        fit: BoxFit.contain,
      )))
    ]);
  }
